            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="slug"
                                   class="form-label">{{ __('deal::deal.slug') }}</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="product_price" class="form-label">{{ __('deal::deal.product_price') }}</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="approved_at"
                                   class="form-label">{{ __('deal::deal.approved_at') }}</label>
